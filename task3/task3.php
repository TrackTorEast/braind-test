...
<?php
	...
	*/
	function strangeMathSearch($n, $k){
		...
		sort($seqArray, SORT_STRING); // Отсортируем как массив строк(Лексикографически)
	...
	if (isset($_POST['n'])) {
		...
		// Отсеем ошибку, когда искомое число больше максимального числа в последовательности
		if ($k<=$n) {
			strangeMathSearch($n, $k);
		} else {
			echo "Искомое число больше самой последовательности!";
		}
	}
